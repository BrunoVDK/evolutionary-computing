...
mutation = uicontrol(ph,'Style','popupmenu', 'String',{MUTATION, 'reciprocal_exchange', 'displacement', 'insertion', 'simple_inversion'}, 'Value',1,'Position',[290 20 130 20],'Callback',@mutation_Callback);
